                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <div className="relative w-full sm:w-auto">
                      ...
                      <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 px-2.5 py-0.5 rounded-full bg-emerald-600 text-white text-[10px] font-bold uppercase tracking-wider shadow-xs whitespace-nowrap pointer-events-none z-10">
                        Rekomendasi
                      </span>
                      <button
                        type="button"
                        onClick={handleWhatsAppDirect}
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-500/40 bg-emerald-50/50 px-6 py-3.5 text-sm font-medium text-emerald-950 transition-all hover:bg-emerald-100/60 cursor-pointer"
                      >
