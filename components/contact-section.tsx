                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <div className="relative w-full sm:w-auto">
                      {/* Label Rekomendasi di atas tombol WhatsApp (Outline Style, tidak di-fill) */}
                      <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 px-2.5 py-0.5 rounded-lg border border-amber-500 bg-white text-amber-600 text-[10px] font-bold uppercase tracking-wider shadow-xs whitespace-nowrap pointer-events-none z-10">
                      ...
                      <button
                        type="button"
                        onClick={handleWhatsAppDirect}
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-300 bg-white px-6 py-3.5 text-sm font-medium text-zinc-800 transition-all hover:bg-zinc-50 cursor-pointer"
                      >
