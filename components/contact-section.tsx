                  ...
                  <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <div className="relative w-full sm:w-auto">
                      ...
                      <button
                        type="button"
                        onClick={handleWhatsAppDirect}
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-500 bg-white px-6 py-3.5 text-sm font-semibold text-emerald-600 shadow-xs transition-all hover:bg-emerald-50 cursor-pointer"
                      >
