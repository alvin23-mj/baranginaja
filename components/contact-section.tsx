                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                    ...
                    <div className="relative w-full sm:w-auto">
                      {/* Label Rekomendasi di atas tombol WhatsApp */}
                      <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 px-2.5 py-0.5 rounded-lg bg-amber-500 text-white text-[10px] font-bold uppercase tracking-wider shadow-xs whitespace-nowrap pointer-events-none z-10">
